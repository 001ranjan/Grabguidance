	...
	ngOnInit(): void {
		...
		this.routerAct.params.subscribe((data) => {
			...
			if (data.searchedClass && data.searchedClass != 'all-classes') {
				...
				console.log('test inside block data');
				console.log('active Class', this.activatedClass = classData[0].class);
			}
			...
			if (this.activatedClass == '10th' && this.activatedSubject == 'maths') {
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take class 10th maths online classes with best teachers who will guide you & help you understand the root of concepts. Book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GrabGuidance has the best experts onboard to provide you with the best academic advising and career counselling through live sessions. Book Now!'
				});
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We have top experts to help you with your class 8 science queries and doubts through live 1:1 sessions. So go ahead & book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We have experienced teachers onboard to help you with your class 8 maths concepts. So go ahead and book a session with us!'
				});
				this.meta.updateTag({
					name: 'og:title',
					content:
						'Online Career Counselling and Academic Advising for Students'
				});
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of the best online career counselling and academic advising? GG has top experts who can guide you in the best way possible'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Learn Class 11th maths From Leading Experts');
				this.meta.updateTag({
					name: 'description',
					content:
						'We have India’s top experts to help you with your class 11th maths queries and doubts. There are live 1:1 sessions. So go ahead and book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
						'class 11th maths, cbse online class 11 maths, online class 11th maths, online classes for class 11 maths cbse, cbse online maths class 11, class 11 maths live classes, class 11 maths ncert online'
				});
				this.meta.updateTag({
					name: 'og:title',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of an excellent online career counselling and academic advising? GG has top experts who can guide you in the best way possible. Call Now!'
				});
			} 
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We have the leading experts onboard to help you with your class 8 social science doubts through interactive live sessions.So do not  wait anymore and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GG provides the best online doubt solving and career counselling for students in India through leading experts onboard. Book a Session Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GG has the best experts onboard to provide you with the best academic advising and career counselling through interactive live sessions. Book Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of an excellent online career counselling and academic advising? GG has top experts who can guide you in the best possible way'
				});
			}
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Get career counselling and academic guidance at GrabGuidance through 1:1 live sessions from India best leading experts. Book a session Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GrabGuidance provides the best online doubt solving and career counselling for students in India through leading experts onboard. Book a session Now!'
				});
			}
			...
			// change
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GrabGuidance provides the best online doubt solving and career counselling for students in India through leading experts onboard. Book Now!'
				});
			}
			
			else if (this.activatedClass == '10th' && this.activatedSubject == 'social science') {
				this.title.setTitle('Get Online Experts For Class 10th social science | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'We have top experts to help you with your class 10th social science queries and doubts through live interactive 1:1 sessions. Go ahead and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Get Online Experts For Class 9 social science | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'We have top experts to help you with your class 9 social science queries and doubts through live interactive 1:1 sessions. So go ahead and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GrabGuidance has the best experts onboard to provide you with the best academic advising and career counselling through interactive live sessions. Book Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'og:title',
					content:
						'1:1 Academic and Career Guidance | Best doubt Solving Website'
				});
				this.meta.updateTag({
					name: 'og:description"',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of an excellent online career counselling and academic advising? GG has top experts who can guide you in the best way possible'
				});
			}
				...
				this.title.setTitle('Learn Class 12th maths From Leading Experts');
				this.meta.updateTag({
					name: 'description',
					content:
						'We have India’s top experts to help you with your class 12th maths queries and doubts. There are live 1:1 sessions. So go ahead and book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
						'class 12th maths, 12th maths online classes, best online classes for class 12 maths, class 12 maths online classes, online classes for class 12 maths, online class 12 maths, online math class 12, online 12th maths classes, 12th maths classes online, plus two maths online class, live class 12th math, math online class 12, class 12 maths live classes'
				});
			} 
				...
				this.title.setTitle('Book Online Class For Class 10th science With Our Top Experts');
				this.meta.updateTag({
					name: 'description',
					content:
				...
				this.meta.updateTag({
					name: 'keywords',
					content:
						'class 10th science, cbse online science class 10, online class 10 science, class 10 science cbse online, class 10 cbse online science, science class 10 cbse online, cbse online 10 science, online class 10th science, cbse online class 10th science, 10th class science online classes'
				});
			} 
				...
				this.title.setTitle('Get Online Experts For Class 11th Business Studies | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'We have top experts to help you with your class 11th business studies queries and doubts through live interactive 1:1 sessions. Go ahead and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book a session for class 11th chemistry with experienced teachers to help you with your doubts. You can choose the expert of your choice from the list'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'keywords',
					content:
						'class 11th biology, cbse online biology class 11, online class 11 biology, online classes for class 11 biology, online biology class 11, 11th class online classes biology, biology cbse online class 11, class 11 biology cbse online, class 11 cbse online biology'
				});
				this.meta.updateTag({
					name: 'og:title',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We`ve top experts to help you with your class 12th business studies queries and doubts through live interactive 1:1 sessions. So go ahead and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take class 12th accounts online classes with best experienced teachers who will help you understand the root of concepts. Book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'og:description" content="GrabGuidance provides the best online doubt solving and career counselling for students in India through leading experts onboard. Book a Session Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Get career counselling and academic guidance at GrabGuidance through 1:1 live sessions from India`s best leading experts. Book a session Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book a session for class 12th chemistry with top teachers to help you with your queries and doubts. You can choose the expert of your choice from the list'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Top leading teachers with years of expertise to help you with your bba marketing management queries. There are live 1:1 sessions. Book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Get Online Experts For BBA Digital Marketing | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'We`ve top experts to help you with your bba digital marketing queries and doubts through live interactive 1:1 sessions. Book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take sales and distribution management bba online class with experienced teachers who will guide you and help you to understand the root of concepts'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We`ve India’s top experts to help you with your bba human resource management queries and doubts. There are live 1:1 sessions. Call Us Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Get Online Experts For BBA Organisation Behaviour | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'We`ve experienced teachers onboard to help you with your bba organisation behaviour concepts. Go ahead and book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book a session for bba production and operations management with India`s top teachers to help you with your queries and doubts. Click here to know more!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We have the leading experts onboard to help you with your bba business economics doubts through interactive live sessions. Don`t wait and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
			...
			else if (this.activatedClass == 'B.Com' && this.activatedSubject == 'financial management') {
				this.title.setTitle('Get Online Expert For BBA Financial Management');
				this.meta.updateTag({
					name: 'description',
					content:
				...
				this.meta.updateTag({
					name: 'keywords',
					content:
						'BBA financial management, online b.com financial management, online classes for b.com financial management, b.com online classes financial management, b.com financial management live classes'
				});
				this.meta.updateTag({
					name: 'og:title',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'India’s top teachers to help you with your doubts and make you deeply understand the concepts of B.com business communication through live sessions'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of an best online career counselling and academic advising? GG has top experts who can guide you in the best way possible. Call Us Now'
				});
			}
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take B.com business economics 1:1 online classes with experienced teachers who will guide you and help you understand the root of concepts. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GG provides the best online doubt solving and career counselling for students in India through leading experts onboard. Book a Session with us Now'
				});
			}

			else if (this.activatedClass == 'B.Com' && this.activatedSubject == 'taxation') {
				this.title.setTitle('Learn B.Com Taxation With Experienced Teachers | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has leading experts onboard to help you with your b.com taxation queries and doubts through live interactive 1:1 sessions. Book a sesion now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GrabGuidance has the best experts onboard to provide you with the best academic advising and career counselling through interactive sessions. Book Now!'
				});
			}
			else if (this.activatedClass == 'BBS' && this.activatedSubject == 'business communication') {
				this.title.setTitle('Learn BBS Business Communication From Experts | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'GrabGuidance has best experienced teachers onboard to help you with your BBS business communication concepts. Go ahead and book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
			...
			else if (this.activatedClass == 'BBS' && this.activatedSubject == 'Taxation') {
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has India’s top experts to help you with your BBS management accounting queries & doubts. There are live 1:1 sessions. Go ahead and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We have best leading experts onboard to help you with your BBsSmarketing management doubts and concepts through interactive 1:1 live sessions. Call Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of the best online career counselling and academic advising? GG has top experts who can guide you in the best way possible. Call Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Top leading teachers with years of expertise to help you with your bbs organisation behaviour queries. There are live 1:1 sessions. Go ahead and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take bbs human resource management online sessions with best teachers who will guide you and help you understand the root of concepts. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'og:description" content="GG has the best experts onboard to provide you with the best academic advising and career counselling through interactive live sessions. Book Now!'
				});
			}

			else if (this.activatedClass == 'BBS' && this.activatedSubject == 'financial management') {
				this.title.setTitle('Get Online Experts For BBS Financial Management | May 2022');
				this.meta.updateTag({
					name: 'description',
					content: 
						'GG has top experts to help you with your bbs financial management queries and doubts through live interactive 1:1 sessions. Click here to know more!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Get career counselling and academic guidance at GG through 1:1 live sessions from India`s best leading experts. Go ahead and book a session Now!'
				});
			}
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book an online session at GG for bms management accounting with top teachers to help you understand the concepts clearly. Call Us Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Learn BMS Marketing Management From Experts | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Learn bms financial management at GG from experienced teachers who will guide you and help you understand the root of concepts. Book a Session Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Get Online Experts For BBE Organisation Behaviour | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'We`ve top experts to help you with your bbe organisation behaviour concepts and  doubts through live interactive 1:1 sessions. Click here to know more'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'GG provides bca organisation behaviour online classes from best teachers who will guide you and help you understand the root of concepts. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'GrabGuidance has experienced teachers onboard to help you with your bca programming language concepts. Book a session now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book a session for bca system analysis and design with experienced teachers at GG to help you with your queries and doubts. Click here to know more'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of an excellent online career counselling and academic advising? GG has top experts who can guide you in the best way. Call Us Now!'
				});
			}

			else if (this.activatedClass == 'BCA' && this.activatedSubject == 'financial management') {
				this.title.setTitle('Get Online Experts For BCA Financial Management | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has top experts to help you with your bca financial management queries & doubts through live 1:1 sessions. So go ahead and book a session now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Get Online Experts For BA Quants & Statistics | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
			...
			else if (this.activatedClass == 'MA' && this.activatedSubject == 'organisation behaviour') {
				this.title.setTitle('Get Online Classes For MA Organisation Behaviour From Exper');
				this.meta.updateTag({
					name: 'description',
					content:
						'Take MA organisation behaviour online classes with best experienced teachers who will guide you and help you understand the root of concepts. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
						'ma organisation behaviour, online ma organisation behaviour, ma organisation behaviour online classes, ma organisation behaviour live classes'
				});
				this.meta.updateTag({
					name: 'og:title',
					content:
				...
				this.title.setTitle('Get Online Experts For MA Business Communication | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has India`s top experts to help you with your MA business communication queries and doubts through live interactive 1:1 sessions. Book now!">'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Learn MA Business Economics From Top Experts | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'Book online sessions at GG for MA business economics with best experienced teachers to get all your concepts and doubts cleared. Learn more!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Book Live session with Best Experts for MA Quants and Statistics');
				this.meta.updateTag({
					name: 'description',
					content:
						'We at GrabGuidance have India’s top experts to help you with your MA quants and statistics queries and doubts. There are live 1:1 sessions. Call Us Now'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take MBA business communication online classes with top teachers at GG who will guide you and help you understand the root of concepts. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book a session for MBA financial management with experienced teachers to help you with your queries and doubts through live sessions. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has leading experts onboard to help you with your MBA production and operations management doubts through 1:1 live sessions. Call Us Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Get Online Experts For MBA Business Economics | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'GrabGuidance has top experts to help you with your MBA business economics queries and doubts through live interactive 1:1 sessions. Book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take M.Com organisation behaviour online classes with best experienced teachers who will guide you and help you understand the root of concepts'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book a session for M.Com human resource management with experienced teachers at GG to help you with your queries and doubts. Live Sessions. Call us now'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
						'mcom human resource management, m.com human resource management, online human resource management classes for m.com, online classes for m.com human resource management, m.com human resource management live classes'
				});
				this.meta.updateTag({
					name: 'og:title',
					content:
				...
				this.title.setTitle('Get Online Experts For PGDM Organisation Behaviour');
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has top experts to help you with your PGDM organisation behaviour queries and doubts through interactive live 1:1 sessions. Click here to know more'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We`ve experienced teachers onboard to help you with your PGDM business communication concepts through live sessions. Learn more!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'Are you in search of an excellent online career counselling and academic advising? GG has top experts who can guide you in the best possible way. Call now'
				});
			}
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has leading experts onboard to help you with your PGDM production and operations management doubts through interactive live sessions. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Book a session at GG for PGDM financial management with experienced teachers to help you with your queries and doubts. Click here to know more'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Best Online Class for PGDM Sales and Distribution Management');
				this.meta.updateTag({
					name: 'description',
					content:
						'Take PGDM sales and distribution management online classes with top experts who will guide you and help you understand the root of concepts. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'og:description"',
					content:
						'GrabGuidance provides the best online doubt solving and career counselling for students in India through leading experts onboard. Learn more!'
				});
			}
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We`ve top experts to help you with your PGDM supply chain management and doubts through live interactive 1:1 sessions. Learn more!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Learn PGDM In Digital Marketing Leading Experts | May 2022');
				this.meta.updateTag({
					name: 'description',
					content:
						'We at GrabGuidance have experienced teachers onboard to help you with your PGDM digital marketing concepts. Book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We have India’s top experts to help you with your MCA organisation behaviour queries and doubts. There are live 1:1 sessions. Book a session with us!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'We have the leading experts onboard to help you with your dbms MCA doubts through interactive live sessions. So don`t wait anymore and book now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.title.setTitle('Book a Class for MCA System Analysis and Design with Experts');
				this.meta.updateTag({
					name: 'description',
					content:
						'GG has top leading teachers with years of expertise to help you with your MCA system analysis and design queries. There are live 1:1 sessions. Book Now!'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
				...
				this.meta.updateTag({
					name: 'description',
					content:
						'Take MCA management accounting online classes with best experienced teachers who will guide you and help you understand the root of concepts. Call now'
				});
				this.meta.updateTag({
					name: 'keywords',
					content:
						'keywords" content="mca management accounting, online mca management accounting, online classes for mca management accounting, mca management accounting live classes'
				});
				this.meta.updateTag({
					name: 'og:title',
					content:
